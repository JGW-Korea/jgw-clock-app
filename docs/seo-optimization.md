...
![구글 자연 검색 결과 클릭율 통계](./images/google-organic-ctr.png)

<br />

이처럼 광고에 대한 거부감을 유발하지 않으면서도 **자연 검색 결과 내 노출 우선순위를 높이기 위한 일련의 과정**을 **SEO(Search Engine Optimitzation)**라고 합니다.

물론 **SEO를 통해 자연 검색 결과의 순위를 높이기 위해서**는 단순히 개발 영역을 넘어 **마케팅**, **브랜딩** 등 **다양한 지식에 대한 이해도 함께 요구**됩니다. 따라서 본 문서에서는 이러한 범위를 모두 다루기보다, **개발자 도구의 Lighthouse를 활용하여 개발 관점에서 SEO 점수를 개선하기 위해 수행한 과정에 한정해 서술**하겠습니다.
